...
#include "fe_port.h" /* klisp: was <stdlib.h>, <stdio.h> — no libc in kernel */

#define FE_VERSION "1.0"

typedef long fe_Number; /* klisp: integer-only (kernel forbids floating point) */
...
/* klisp: fe_writefp removed (no FILE in kernel) */
...
/* klisp: fe_readfp removed (no FILE in kernel) */
